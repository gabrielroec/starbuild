  ...
  return (
    <>
      <section className="h-full w-full md:pt-44 mt-[-70px] relative flex items-center justify-center flex-col ">
        ...
        <p className="text-center font-bold">A sua agência em um só lugar</p>
      ...
      <section className="flex justify-center flex-col items-center gap-4 mt-20">
        <h2 className="text-4xl text-center">Escolha o que combina mais com você.</h2>
        <p className="text-muted-foreground text-center">
          Nossos planos de preços simples são adaptados para atender às suas necessidades. Se
          {" você"} não <br />
          está pronto para se comprometer, você pode começar gratuitamente.
        </p>
        <div className="flex justify-center gap-4 flex-wrap mt-6">
          {pricingCards.map((card) => (
            <Card
              key={card.title}
              className={clsx("w-[300px] flex flex-col justify-center", { "border-2 border-primary": card.title === "SaaS Ilimitado" })}
            >
              <CardHeader>
